...
<div class="container my-8 mx-auto">
    ...
    <div class='flex w-full bg-white py-20'>
        ...
        <div class='container'>
            ...
            <div class='text-center w-1/2 mx-auto mb-20'>

                <h2 class='font-jcHeading2 font-bold text-3xl w-4/5 m-auto'>Let's grow your business together using our suite of services</h2>
            </div>

            <div class='grid gap-12 grid-cols-2'>

                <div class='flex '>
                    <img src='/wp-content/themes/tailpress/resources/img/webdev.jpg' />
                </div>
                <div class='w-full m-auto'>
                    <h2 class='mb-2 text-gray-800 font-jcHeading2 font-medium'>Web Development</h2>
                    <p class='text-gray-500 text-base font-jcSubHeading'>Jacob Creative is proud to offer a wide array of Web Development services ranging from Landing Pages to fully featured Web Applications and everything in-between. Whether you're building a brand new online presence or updating an old one, we're focued on putting the client first every step of the way. From design mockups to technology decisions, we're determined to deliver on your vision in the most efficient and effective way possible.</p>
